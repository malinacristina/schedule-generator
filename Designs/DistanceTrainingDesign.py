...
# Form implementation generated from reading ui file 'C:\Users\marinc\AutonoMouse\Software\schedule-generator\UI\DistanceTrainingUI.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.GuideValveTargetAmplitudeEdit = QtWidgets.QLineEdit(Form)
        self.GuideValveTargetAmplitudeEdit.setObjectName("GuideValveTargetAmplitudeEdit")
        self.gridLayout.addWidget(self.GuideValveTargetAmplitudeEdit, 9, 1, 1, 1)
        self.label_12 = QtWidgets.QLabel(Form)
        self.label_12.setObjectName("label_12")
        self.gridLayout.addWidget(self.label_12, 8, 0, 1, 1)
        self.GuideValveShatterFreqEdit = QtWidgets.QLineEdit(Form)
        self.GuideValveShatterFreqEdit.setObjectName("GuideValveShatterFreqEdit")
        self.gridLayout.addWidget(self.GuideValveShatterFreqEdit, 9, 2, 1, 1)
        self.GuideValveTargetEdit = QtWidgets.QLineEdit(Form)
        self.GuideValveTargetEdit.setObjectName("GuideValveTargetEdit")
        self.gridLayout.addWidget(self.GuideValveTargetEdit, 9, 0, 1, 1)
...
" 9 = guide valve blank"))
        ...
        self.label_15.setText(_translate("Form", "Guide Valve Shatter Frequency (Hz)"))
        self.label_14.setText(_translate("Form", "Guide Valve Target Amplitude"))
        self.GuideValveTargetAmplitudeEdit.setText(_translate("Form", "0.5"))
        self.label_12.setText(_translate("Form", "Guide Valve Target"))
        self.GuideValveShatterFreqEdit.setText(_translate("Form", "500"))
        self.GuideValveTargetEdit.setText(_translate("Form", "8"))
